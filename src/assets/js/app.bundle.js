...
var initApp = (function(app) {
	...
	app.factoryReset = function () {
		...
		if (typeof bootbox  != 'undefined') {
			...
			bootbox.confirm({
				...
				message: "<span><strong>Warning:</strong> This action is not reversable. You will lose all your layouts settings.</span>",
				centerVertical: true,
	...
	/**
	 * checkNavigationOrientation by checking layouts conditions
...
var layouts = (function(setlayout) {
	...
	// ALT Approach
	/*setlayout.modeDark = function(layouts) {
		if (layouts === 'on') {
			initApp.pushSettings('mod-skin-dark')
		} else if (layouts === 'off') {
			initApp.removeSettings('mod-skin-dark')
		} else {
			layouts.errorMessage(layouts);
		}
	};
	setlayout.modeLight = function(layouts) {
		if (layouts === 'on') {
	...
	//layouts.fontSize('sm');
	// TODO
	/*setlayout.fontSize = function(layouts) {
		...
		switch ( true ) {
			...
			default:
				console.log("('" + layouts + "')" +" is not a valid entry, enter 'sm', 'md', 'lg', or 'xl'");
				break;
		}
