...
export class AgregarPagoEstimuloApiTrabajoGuard implements CanActivate {
  eventoId: number
  ...
  canActivate(
    ...
    this.eventoId = Number(route.paramMap.get('idevent') || route.paramMap.get('eventoId') || 0);
    const autorizar = this.permisosScicomService.canAgregarPagoEstimuloApiEvento(this.eventoId)
