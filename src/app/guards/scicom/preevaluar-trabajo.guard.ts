...
export class PreevaluarTrabajoGuard implements CanActivate {
  eventoId: number
  ...
  canActivate(
    ...
    const autorizar = this.permisosScicomService.canAgregarPreevaluacionTrabajoEvento(this.eventoId)
