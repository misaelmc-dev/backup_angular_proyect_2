...
@Component({
  selector: 'app-event-update-encounter',
  templateUrl: './event-update-encounter.component.html',
  styleUrls: ['./event-update-encounter.component.css']
})
export class EventUpdateEncounterComponent implements OnInit {
