...
@Component({
  selector: 'app-event-participations-encounter',
  templateUrl: './event-participations-encounter.component.html',
  styleUrls: ['./event-participations-encounter.component.css']
})
export class EventParticipationsEncounterComponent implements OnInit {
  ...
  navigateToNewParticipation() {
    this.router.navigate([`/scicom/encuentro/${this.eventoId}/event-participation-new/${this.currentUsuarioScicomId}`])
  }
  ...
  setFechaInicio(fecha: any) {
    ...
    this.partFechaInicio = this.dateStringToIso8601Start(fecha);
  }

  setFechaFinal(fecha: any) {
    this.showFechaFinal = fecha;
    this.partFechaFinal = this.dateStringToIso8601End(fecha);
  }
