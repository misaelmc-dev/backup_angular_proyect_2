...
@Component({
  selector: 'app-event-participation-new-encounter',
  templateUrl: './event-participation-new-encounter.component.html',
  styleUrls: ['./event-participation-new-encounter.component.css']
})
export class EventParticipationNewEncounterComponent implements OnInit {
