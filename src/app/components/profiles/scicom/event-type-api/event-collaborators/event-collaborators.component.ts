...
import {CollaboratorsService} from "../../../../../services/scicom/collaborators.service";

@Component({
  selector: 'app-event-collaborators',
  templateUrl: './event-collaborators.component.html',
  styleUrls: ['./event-collaborators.component.css']
})
export class EventCollaboratorsComponent implements OnInit {
  ...
  constructor(private eventService: EventService,
              ...
              public colaboradoresService: CollaboratorsService){ }
  ...
  loadColaboradoresEvento = () => {
    if(this.eventoId!=0){
      this.loadingCount++
      this.colaboradoresService.getCollaboratorByEvent(this.pageNumber,this.pageSize,[this.eventoId]).subscribe((res: any) => {
        this.loadingCount--
        ...
        if(this.userScitraId!=0) {
          ...
          this.eventService.addScicomUser(this.rolSelected, this.userScitraId, this.eventoId).subscribe((res: any) => {
            ...
            for(let camp of this.campus){
              this.loadingCount++
              this.eventService.addCampusToUser(this.userScicomId,camp.id).subscribe((res: any) => {
                this.loadingCount--
                console.log("campus agregado");
              }, (err:any) =>{
                this.loadingCount--
