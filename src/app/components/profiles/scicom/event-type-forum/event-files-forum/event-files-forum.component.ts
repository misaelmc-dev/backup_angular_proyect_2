...
@Component({
  selector: 'app-event-files-forum',
  templateUrl: './event-files-forum.component.html',
  styleUrls: ['./event-files-forum.component.css']
})
export class EventFilesForumComponent implements OnInit {
