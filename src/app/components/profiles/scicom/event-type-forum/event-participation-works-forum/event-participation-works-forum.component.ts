...
@Component({
  selector: 'app-event-participation-works-forum',
  templateUrl: './event-participation-works-forum.component.html',
  styleUrls: ['./event-participation-works-forum.component.css']
})
export class EventParticipationWorksForumComponent implements OnInit {
    ...
    if (this.eventoId != 0 && this.eventoTipo != 0) {
      ...
      this.eventService.getWorkTypeList(this.eventoId, this.eventoTipo).subscribe((resTrabTip: any) => {
        ...
        for (let tt of resTrabTip) {
          if (tt.nombre == "Conferencia Magistral foro UVM") {
