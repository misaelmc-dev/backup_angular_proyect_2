...
@Component({
  selector: 'app-event-participation-files-forum',
  templateUrl: './event-participation-files-forum.component.html',
  styleUrls: ['./event-participation-files-forum.component.css']
})
export class EventParticipationFilesForumComponent implements OnInit {

  @Input('eventoId') eventoId:number = 0;
  @Input('participacionId') participacionId:number = 0;

  eventoTipoId:number=3;
