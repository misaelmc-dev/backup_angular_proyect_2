...
@Component({
  selector: 'app-event-participation-details-forum',
  templateUrl: './event-participation-details-forum.component.html',
  styleUrls: ['./event-participation-details-forum.component.css']
})
export class EventParticipationDetailsForumComponent implements OnInit {
