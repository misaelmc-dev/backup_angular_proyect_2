...
@Component({
  selector: 'app-event-campus-forum',
  templateUrl: './event-campus-forum.component.html',
  styleUrls: ['./event-campus-forum.component.css']
})
export class EventCampusForumComponent implements OnInit {
