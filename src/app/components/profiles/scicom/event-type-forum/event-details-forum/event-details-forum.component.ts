...
import {forEach} from "lodash"; //importación de lenguaje de moment en localización "español mexicano"

@Component({
  selector: 'app-event-details-forum',
  templateUrl: './event-details-forum.component.html',
  styleUrls: ['./event-details-forum.component.css']
})
export class EventDetailsForumComponent implements OnInit {
