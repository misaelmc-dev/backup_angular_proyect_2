...
@Component({
  selector: 'app-event-collaborators-forum',
  templateUrl: './event-collaborators-forum.component.html',
  styleUrls: ['./event-collaborators-forum.component.css']
})
export class EventCollaboratorsForumComponent implements OnInit {
