...
@Component({
  selector: 'app-event-participation-cartels-forum',
  templateUrl: './event-participation-cartels-forum.component.html',
  styleUrls: ['./event-participation-cartels-forum.component.css']
})
export class EventParticipationCartelsForumComponent implements OnInit {

  @Input('eventoId') eventoId: number = 0;
  @Input('participacionId') participacionId: number = 0;

  eventoTipo: number = 3;
  cartelesTiposIds: any[] = [3,4];
