...
@Component({
  selector: 'app-event-objectives-forum',
  templateUrl: './event-objectives-forum.component.html',
  styleUrls: ['./event-objectives-forum.component.css']
})
export class EventObjectivesForumComponent implements OnInit {
