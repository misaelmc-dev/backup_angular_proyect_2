...
@Component({
  selector: 'app-colab-center-origen-linea-coord',
  templateUrl: './colab-center-origen-linea-coord.component.html',
  styleUrls: ['./colab-center-origen-linea-coord.component.css']
})
export class ColabCenterOrigenLineaCoordComponent implements OnInit {
