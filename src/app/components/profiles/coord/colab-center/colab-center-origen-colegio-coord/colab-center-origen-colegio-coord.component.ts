...
@Component({
  selector: 'app-colab-center-origen-colegio-coord',
  templateUrl: './colab-center-origen-colegio-coord.component.html',
  styleUrls: ['./colab-center-origen-colegio-coord.component.css']
})
export class ColabCenterOrigenColegioCoordComponent implements OnInit {
