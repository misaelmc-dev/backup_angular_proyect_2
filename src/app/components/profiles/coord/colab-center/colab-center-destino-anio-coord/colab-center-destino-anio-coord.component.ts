...
@Component({
  selector: 'app-colab-center-destino-anio-coord',
  templateUrl: './colab-center-destino-anio-coord.component.html',
  styleUrls: ['./colab-center-destino-anio-coord.component.css']
})
export class ColabCenterDestinoAnioCoordComponent implements OnInit {
  @Input() titulo: string = ''
