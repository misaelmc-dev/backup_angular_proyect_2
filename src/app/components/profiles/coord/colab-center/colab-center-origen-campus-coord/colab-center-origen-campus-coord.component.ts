...
@Component({
  selector: 'app-colab-center-origen-campus-coord',
  templateUrl: './colab-center-origen-campus-coord.component.html',
  styleUrls: ['./colab-center-origen-campus-coord.component.css']
})
export class ColabCenterOrigenCampusCoordComponent implements OnInit {
