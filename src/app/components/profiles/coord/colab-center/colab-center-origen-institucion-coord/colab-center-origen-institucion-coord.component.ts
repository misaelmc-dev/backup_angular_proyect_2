...
@Component({
  selector: 'app-colab-center-origen-institucion-coord',
  templateUrl: './colab-center-origen-institucion-coord.component.html',
  styleUrls: ['./colab-center-origen-institucion-coord.component.css']
})
export class ColabCenterOrigenInstitucionCoordComponent implements OnInit {
