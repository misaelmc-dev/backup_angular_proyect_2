...
@Component({
  selector: 'app-colab-center-destino-pais-coord',
  templateUrl: './colab-center-destino-pais-coord.component.html',
  styleUrls: ['./colab-center-destino-pais-coord.component.css']
})
export class ColabCenterDestinoPaisCoordComponent implements OnInit {
  @Input() titulo: string = ''
  ...
  paises: Array<any> = []; //arreglo de países
  showElemList: boolean;
  selectedPaisId: number //id seleccionado al hacer clic
  selectedPaisNombre: string //nombre seleccionado al hacer clic
  ...
  ngOnInit(): void {
    ...
    this.tiposElementosDestino.push('paises')
  ...
  onElementClicked(id: number, nombre: string) {
    ...
    this.selectedPaisNombre = nombre
