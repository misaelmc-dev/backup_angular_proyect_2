...
@Component({
  selector: 'app-international-ad',
  templateUrl: './international-ad.component.html',
  styleUrls: ['./international-ad.component.css']
})
export class InternationalAdComponent implements OnInit {

  id!: any;
  url!: string;
  urlWithFilters: string
  startYear: string = '1997'; //filtro desde año tal
  ...
  constructor(private activatedRoute: ActivatedRoute,
    ...
    this.url = `${this.globals.base_sig_url}/?solo_internacional&por_institucion&id_institucion=${this.id}`;
    this.urlWithFilters = `${this.globals.base_sig_url}/?solo_internacional&por_institucion&id_institucion=${this.id}`;
  }
  ...
  ngOnInit(): void {
    ...
    this.setPossiblePaises(this.id) //se llenan los posibles valores para filtrar por país destino
    this.loadCampusList()
  }
  ...
  setPossiblePaises(id: string) {
    this.collaborationService.getCollaborationData('instituciones', ['paises'],
      [parseInt(id)], null, null, null, null,
      null, null, null, null, null,
      true, null).subscribe(
      //tod ok
